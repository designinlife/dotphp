...
ZEND_BEGIN_ARG_INFO_EX(arginfo_dotphp_webbootstrap_defexceptionhandler, 0, 0, 1)
...
ZEPHIR_INIT_FUNCS(dotphp_webbootstrap_method_entry) {
	...
	PHP_ME(DotPHP_WebBootstrap, defExceptionHandler, arginfo_dotphp_webbootstrap_defexceptionhandler, ZEND_ACC_PUBLIC)
